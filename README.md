...
2. **EDA**: Analyzed temporal trends, win rates by day of the week, and team efficiency.


3. **Modeling**: Applied a randomized 80-20 split on historical data for training and evaluation.
